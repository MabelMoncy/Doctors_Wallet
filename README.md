...
1. Download and install [GitHub Desktop](https://desktop.github.com/) for your operating system.
...
**2. IDE:**
   - [Eclipse IDE for Java Developers](https://www.eclipse.org/downloads/packages/) (best for `.project` support, runs on all OS).
   - Alternatives: [IntelliJ IDEA Community](https://www.jetbrains.com/idea/download/), [Apache NetBeans](https://netbeans.apache.org/download/), [VS Code with Java Extension Pack](https://code.visualstudio.com/docs/languages/java).
